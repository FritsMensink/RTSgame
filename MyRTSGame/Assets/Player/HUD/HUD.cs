...
public class HUD : MonoBehaviour {
	...
	public Texture2D[] moveCursors, attackCursors;	
	...
	//if the selection changes we want to make sure that we are showing the list from the top, not from where a previous list may have been scrolled to,
	private WorldObject lastSelection;
	//The variable sliderValue is what we are using to determine what position the scrollbar should be drawn at.
	...
	private void DrawOrdersBar() {
		...
		GUI.skin = ordersSkin;
		//maak een group vanaf screen coordinates.
